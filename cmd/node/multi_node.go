...
func ActivateGrpcServer(smApp *App) {
	...
	smApp.globalstateSvc = grpcserver.NewGlobalStateService(smApp.mesh, smApp.cState)
	smApp.txService = grpcserver.NewTransactionService(smApp.host, smApp.mesh, smApp.cState, smApp.syncer)

...
//}
//
//func addTransactions(t testing.TB, mesh *DB, numOfTxs int, fee int64) (int64, []types.TransactionID) {
//	var totalFee int64
...
//		fee, txIDs := addTransactions(t, tm.DB, data.numOfTxs, data.fee)
//		totalFee += fee
//		p := &types.Proposal{
...
//	reward, txIDs := addTransactions(t, mesh.DB, rand.Intn(maxTransactions), rand.Int63n(100))
//	p := &types.Proposal{
//		InnerProposal: types.InnerProposal{
//			Ballot: types.Ballot{
//				InnerBallot: types.InnerBallot{
...
//}
//
//func createLayerBlocks(t testing.TB, mesh *Mesh, lyrID types.LayerID, numOfBlocks, maxTransactions int, atxDB *AtxDbMock) (totalRewards int64, blocks []*types.Block) {
...
//		reward, _ := createLayerBlocks(t, tm.Mesh, i, numOfBlocks, numTXs, tm.mockATXDB)
...
//		_, blocks := createLayerBlocks(t, tm.Mesh, i, numOfBlocks, numTXs, atxDB)
//		oldVerified := i.Sub(2)
//		if oldVerified.Before(gLyr) {
//			oldVerified = gLyr
//		}
